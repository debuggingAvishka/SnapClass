...
from src.pipelines import predict_attendance
...
def teacher_screen_login():
    ...
    teacher_username= st.text_input("Enter username", placeholder='example_name') 
    
    teacher_pass = st.text_input("Enter password", placeholder='example@12pass')
...
def teacher_screen_register():
    ...
    teacher_pass = st.text_input("Enter password", type="password",placeholder='example@12pass')
    teacher_pass_confirm = st.text_input("Confirm your password", type="password",placeholder='example@12pass')
